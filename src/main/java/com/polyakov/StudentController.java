...
public class StudentController {
    ...
    public String createStudentAdd(Model model) {
    ...
    public String updateStudent(@PathVariable Long id, @ModelAttribute("student")
        ...
        existingStudent.setGroupNum(student.getGroupNum());
    ...
    public String deleteStudentReq(@PathVariable Long id, Model model) {
        model.addAttribute("student", studentService.getStudentById(id));
